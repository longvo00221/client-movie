...
const MediaDetail = () => {
  ...
  const onFavoriteClick = async () => {
    if (!userState) return dispatch(setAuthModalOpen(true));
  ...
  const [mediaIdMovie, setMediaIdMovie] = useState();
            ...
            <Box sx={style}>
              ...
              >
                <TvSeries
                  ...
                  id={media.id}
                  image={media.images.backdrops}
                  mediaType={mediaType}
                  overview={media.overview}
                  movieName={media.original_name}
                ...
                <Stack direction="row" spacing={1}>
                  ...
                  >
                    {mediaType === "tv" ? (
                      ...
                      <div>
                        <div onClick={() => handleWatchNowClick(media.id)}>
                          Watch Now
                        </div>
                      </div>
                    )}
